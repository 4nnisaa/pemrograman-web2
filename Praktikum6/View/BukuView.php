...
<h1>Daftar Buku</h1>
<div class= "my-3">
    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahkanModal"><i class="bi-plus-circle-fill"></i>Tambah</button>
</div>
    <div class="row">
        <div class="col-12">
                ...
                <tbody>
                    ...
                    <?php foreach($data->getData() as $buku):?>
                        ...
                        <tr>
                            ...
                            <a href="/index.php/edit?id=1" class="btn btn-sm btn-succes">
                            <i class="bi bi-pencil-square"></i>Edit</a>

                            <button data-bs-toggle="modal" data-bs-target="#hapusModal" 
                            data-bs-id="1"  class="btn btn-sm btn-danger">
