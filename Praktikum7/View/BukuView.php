                ...
                <tbody>
                    ...
                    <?php foreach($data->getData() as $buku):?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/index.php/edit?id=<?php echo $buku->getId();?>" style="background-color:green; color:white;">
                                <i class="bi bi-pencil-square"></i> Edit</a>
                                <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapusModal" data-bs-id="<?php echo $buku->getId();?>">
