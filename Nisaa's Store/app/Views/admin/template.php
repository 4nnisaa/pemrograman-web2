...
<html lang="en">
  <head>
    ...
    <title>Admin Nisaa's Store</title>
    <link
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <nav class="col-3 sidebar">
          <h4 class="text-center">Admin Nisaa's Store</h4>
          <ul class="nav flex-column">
            <li class="nav-item">
              <a href="<?= base_url('admin/dashboard')?>" class="nav-link active">Dashboard</a>
            </li>
            <li class="nav-item">
              <a href="<?= base_url('admin/daftar-produk')?>" class="nav-link">Daftar Nisaa's Store</a>
            </li>
            <li class="nav-item">
        ...
        <main class="col-9">
          <div class="header">
            <h2>Welcome, Admin Nisaa's Store</h2>
